            ...
            <div class="col-md-9 col-lg-10 col-xl-8 mx-auto ms-xl-0">
                ...
                <a class="navbar-brand d-flex w-full d-lg-none" href="/">
                    <div class="w-md-auto  text-dark">
                        <svg class="w-auto h-8" version="1.1" xmlns="http://www.w3.org/2000/svg"
                ...
                <div class="pb-10 pb-lg-15">
                    <h4 class="d-flex align-items-center text-gray-900">
                        Choose Account Type
                ...
                <div class="position-relative">
                    <div class="row">
                        <div class="col-lg-6">
                            <input type="radio" class="btn-check" name="account_type" value="personal" checked
                ...
                <form method="POST" action="https://webpixels.io/register">
                    ...
                    <!-- <div class="my-6">
                        ...
                        <div class="form-check">
                            <input class="form-check-input" type="checkbox" name="newsletter" id="checkNewsletter">
                            <label class="form-check-label pl-2" for="checkNewsletter">
                                Send me email with hot tips, awesome news, or both.
                            </label>
                        </div>
                    </div>
